...
const cards: Card[] = [
  {
    ...
    icon: { src: "/images/platform/USer-friendly-2.webp", alt: "Demo trading icon" },
   
  },
  {
    title: "Educational Resources",
    desc: "Access courses, webinars, quizzes, and videos to understand key trading concepts.",
    icon: { src: "/images/platform/Education-resources-22.webp", alt: "Education and resources icon" },
  
  },
  {
    title: "24/7 Support",
    desc: "Receive assistance through approved channels from our support team at any time. ",
    icon: { src: "/images/platform/platformsupport.webp", alt: "Customer support icon" },
  },
  {
    title: "Flexible Position Sizing",
    desc: "Manage your exposure with flexible trade sizes in line with your risk comfort.",
    icon: { src: "/images/platform/Flexible-position.webp", alt: "Position sizing icon" },
  },
  {
    title: "Risk-Management Tools",
    desc: "Apply tools such as stop-loss orders to help manage potential losses.",
    icon: { src: "/images/platform/Risk-managment.webp", alt: "Risk management icon" },
  },
];
